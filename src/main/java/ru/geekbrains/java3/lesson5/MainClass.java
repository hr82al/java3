...
public class MainClass {
    ...
    public static final CountDownLatch allReady = new CountDownLatch(CARS_COUNT);
    public static final CountDownLatch startRace = new CountDownLatch(1);
    public static final CountDownLatch raceFinished = new CountDownLatch(CARS_COUNT);
